...
def main() -> int:
    ...
    print(json.dumps({
        ...
        "semantic_candidate_ids": report.get("semantic_candidate_ids", 0),
        ...
        "real_part3_requests": report.get("real_part3_requests", 0),
        ...
        "runtime_reload_success": report.get("runtime_reload_success", False),
