...
[32m[32m[1m28 passed[0m[32m in 9.12s[0m[0m
...
- Job leasing/recovery: included
- Queue idempotency: included
- Skill/version guard: included
- Prompt/data boundary: included
- Tool allowlist intersection: included
- Tool-result compaction: included
- Tool budget/loop guard: included
- Token budget: included
- Retry/dead-letter: included
- Permission fabrication guard: included
- Result/audit integrity: included
- Live model provider: NOT CONNECTED
- Real MT5 runtime: NOT RUN
- Forward shadow worker: NOT RUN
