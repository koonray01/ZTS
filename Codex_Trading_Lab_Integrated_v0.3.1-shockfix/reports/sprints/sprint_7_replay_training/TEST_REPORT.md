...
[32m[32m[1m20 passed[0m[32m in 14.23s[0m[0m
...
artifact_tool.rpc.client.RemoteError: hydrateCrdtFromProto requires an empty collaborative document.
    ...
    - Future-leakage prevention: included
    - Hidden outcome isolation: included
    - Submission freeze: included
    - Multi-ledger judge: included
    - No-trade/no-trigger: included
    - Same-bar ambiguity: included
    - Manual-override attribution: included
    - Partition enforcement: included
    - Real historical validation: NOT RUN
    - Live Codex training: NOT RUN
