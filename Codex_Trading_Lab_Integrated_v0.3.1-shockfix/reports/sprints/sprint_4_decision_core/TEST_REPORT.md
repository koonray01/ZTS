...
[32m[32m[1m19 passed[0m[32m in 9.38s[0m[0m
...
## Classification
- Automated implementation tests: PASS
- End-to-end synthetic dry run: PASS
- Locked schema validation: included in tests
- Directional scenario and entry fixture: included
